...
ResultSet rs = null;
    ...
    private void initComponents() {
        ...
        backBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Createuser/back_icon.png"))); // NOI18N
    ...
    private void addUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addUserBtnActionPerformed
           try{
               ...
               String keyword = usernameTxt.getText();
               String key_input=passwordTxt.getText(); 
               final String secretKey = keyword;
               final String k= "private";
               String us=AES.encrypt(keyword,k);
               //String fn=AES.encrypt(fullnameTxt.getText(), secretKey);
               //String em=AES.encrypt(emailTxt.getText(), secretKey);
               //String cn=AES.encrypt(contactNoTxt.getText(), secretKey);
               String ad=AES.encrypt(addressTxt.getText(), secretKey);
               String pass = AES.encrypt(key_input, secretKey);
