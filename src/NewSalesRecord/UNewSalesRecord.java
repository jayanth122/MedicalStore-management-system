...
public class UNewSalesRecord extends javax.swing.JFrame {
String k;
...
double[] amountPerRows;
     ...
     */
    public UNewSalesRecord(String un) {
        this.k=un;
        initComponents();
    ...
    private void addToCartBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToCartBtnActionPerformed
        ...
        model.addRow(new Object[]{companyCombo.getSelectedItem(),productCategoryCombo.getSelectedItem(), productCombo.getSelectedItem(),quantityTxt.getText(),k});
        ...
        try{
            ...
            int rowsCount = cartTable.getRowCount();
                    for(int i=0; i<rowsCount;i++){
                        ...
                        String sql3 = "SELECT quantity FROM products WHERE product_name='"+cartTable.getValueAt(i, 2).toString()+"'";
    ...
    public void uq(int a,String b){
        ...
        try{
                        ...
                        String sql4 = "UPDATE products SET quantity= '"+String.valueOf(a)+"' WHERE product_name='"+b+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UNewSalesRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new UNewSalesRecord(k).setVisible(true);
            }
        });
    }
