...
double[] amountPerRows;
    ...
    public void populateuser(){
        String z="User";
        try{
            String sql = "SELECT username FROM users WHERE user_type='"+z+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
             while(rs.next()){
               userCombo.addItem(rs.getString("username"));
           }
             userCombo.addItem("Admin");
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }
    }
    ...
    private void initComponents() {
        ...
        userCombo.setFont(new java.awt.Font("Calibri", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(quantityTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(userCombo, javax.swing.GroupLayout.PREFERRED_SIZE, 258, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        backBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\back_icon.png")); // NOI18N
        ...
        doneBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\confirm_icon.png")); // NOI18N
        ...
        removeBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\remove_icon.png")); // NOI18N
        ...
        addToCartBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\add_item_icon.png")); // NOI18N
    ...
    private void addToCartBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addToCartBtnActionPerformed
        ...
        model.addRow(new Object[]{companyCombo.getSelectedItem(),productCategoryCombo.getSelectedItem(), productCombo.getSelectedItem(),quantityTxt.getText(),userCombo.getSelectedItem()});
    ...
    public void insertAllProducts(double val){
       DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
        ...
        for (int i = 0; i < 10; i++) {
            ...
            int rowsCount  = cartTable.getRowCount();
            for(int i =0;i < rowsCount; i++){
               String sql  = "INSERT INTO sales_record(sales_id,product_name,company_name,date_of_sale,quantity,amount,customer) VALUES (?,?,?,?,?,?,?)";
                pst = conn.prepareStatement(sql);
                ...
                pst.setString(7, cartTable.getValueAt(i, 4).toString());
            }
        ...
        try{
            ...
            int rowsCount = cartTable.getRowCount();
                    for(int i=0; i<rowsCount;i++){
                        ...
                        String sql1 = "SELECT quantity FROM products WHERE product_name='"+cartTable.getValueAt(i, 2).toString()+"'";
                        pst = conn.prepareStatement(sql1);
                        rs = pst.executeQuery();
                        if(rs.next()){
                          k=Integer.parseInt(rs.getString("quantity"));
                          k-=Integer.parseInt(cartTable.getValueAt(i, 3).toString());                        
                        }
                        uq(k,cartTable.getValueAt(i, 2).toString());
       ...
       if(des==0){
             try{
                    ...
                    /*for(int i=0; i<rowsCount;i++){
                        ...
                        String sql = "SELECT quantity FROM products WHERE product_name='"+cartTable.getValueAt(i, 2).toString()+"'";
                        pst = conn.prepareStatement(sql);
                        rs = pst.executeQuery();
                        if(rs.next()){
                           int  k;
                     ...
                     JOptionPane.showMessageDialog(null, "Your total bill is "+String.valueOf(sum));
                     updatequantity();
    ...
    public javax.swing.JComboBox userCombo;
