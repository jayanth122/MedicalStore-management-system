...
import ChangePassword.UChangePassword;
import Forms.Medicines.MedicinesPanel;
import NewSalesRecord.UNewSalesRecord;
import SalesRecord.USalesRecord;
...
public class UMainPanel extends javax.swing.JFrame  {
...
String kl;
 ...
 public void uname(String p){
     this.kl=p;
     this.loggedInAsLbl.setText(kl);
 }
    ...
    private void initComponents() {
        ...
        medicineTable.setForeground(new java.awt.Color(102, 102, 255));
        ...
        medicineBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\meds_icon.png")); // NOI18N
        ...
        newSalesBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\sale_icon.png")); // NOI18N
        newSalesBtn.setText("Billing");
        ...
        changePasswordBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\password_change_icon.png")); // NOI18N
        ...
        logOutBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\logout.png")); // NOI18N
        ...
        viewSalesRecordsBtn.setIcon(new javax.swing.ImageIcon("E:\\PRO\\MedicalStore-management-system\\capstone\\Medical Store Management System\\icons\\Application Icon\\sales_record_icon.png")); // NOI18N
        viewSalesRecordsBtn.setText("Sales Record");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(newSalesBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                    .addComponent(logOutBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                    .addComponent(changePasswordBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                    .addComponent(medicineBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 241, Short.MAX_VALUE)
                    .addComponent(viewSalesRecordsBtn, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addGap(79, 79, 79)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(loggedInAsLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 134, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(23, 23, 23)))
                .addGap(300, 300, 300))
            .addGroup(layout.createSequentialGroup()
                .addGap(227, 227, 227)
    ...
    private void newSalesBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newSalesBtnActionPerformed
        UNewSalesRecord nsr =  new UNewSalesRecord(kl);
        close();
        nsr.setVisible(true);
    }//GEN-LAST:event_newSalesBtnActionPerformed

    private void changePasswordBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changePasswordBtnActionPerformed
        UChangePassword cp = new UChangePassword(kl);
        close();
        cp.setVisible(true);
    ...
    private void viewSalesRecordsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewSalesRecordsBtnActionPerformed
        USalesRecord sr = new USalesRecord(kl);
        close();
        sr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UMainPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UMainPanel().setVisible(true);
            }
        });
    }
