...
public class UChangePassword extends javax.swing.JFrame {
String kl;
...
ResultSet rs = null;
     ...
     */
    public UChangePassword(String k) {
        this.kl=k;
        initComponents();
   ...
   public void changePassword(){
       if (newPassTxt.getText().equals(repeatPassTxt.getText())){
           try{
            AES a=new AES();
            String keyword = usernameCombo.getSelectedItem().toString();
            String key_input=newPassTxt.getText(); 
            final String secretKey = keyword;
            String ch = a.encrypt(key_input, secretKey);
            String sql = "UPDATE users SET password='"+ch+"' WHERE username='"+usernameCombo.getSelectedItem()+"'";
    ...
    private void changePasswordTxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_changePasswordTxtActionPerformed
            ...
            try{
                AES a=new AES();
                String keyword = usernameCombo.getSelectedItem().toString();
                String key_input=currentPassTxt.getText(); 
                final String secretKey = keyword;
                String ch = a.encrypt(key_input, secretKey);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UChangePassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new UChangePassword().setVisible(true);
            }
        });
    }
